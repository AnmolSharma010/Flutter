...
import 'package:mainpage/studentmainpage.dart';
...
SizedBox(
  height: 20,
           ...
           Container(padding: EdgeInsets.all(20),
            child: Expanded(child: Text("DOSEL",style: TextStyle(fontWeight: FontWeight.w900,fontStyle: FontStyle.italic,color: Colors.blue,fontSize: 40),),
            ),
            ),
                ],
        ),
